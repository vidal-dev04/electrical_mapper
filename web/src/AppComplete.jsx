  ...
  const initMap = () => {
    ...
    try {
      ...
      map.on('pm:create', (e) => {
        ...
        const geometryType = e.shape === 'Marker' ? 'point' : e.shape === 'Line' ? 'line' : 'polygon'
  ...
  const renderFormFields = () => {
    ...
    switch (geometryType) {
      case 'point':
        return (
          <>
            <FormField label="Type" name="type" value={formData.type} onChange={setFormData} />
            <FormField label="Identifiant" name="identifiant" value={formData.identifiant} onChange={setFormData} />
            <FormField label="Tension (V)" name="tension" value={formData.tension} onChange={setFormData} type="number" />
            <FormField label="État" name="etat" value={formData.etat} onChange={setFormData} />
            <FormField label="Couleur" name="couleur" value={formData.couleur || '#3388ff'} onChange={setFormData} type="color" />
          </>
        )
      case 'line':
        return (
          <>
            <FormField label="Type de ligne" name="type_ligne" value={formData.type_ligne} onChange={setFormData} />
            <FormField label="Tension (V)" name="tension" value={formData.tension} onChange={setFormData} type="number" />
            <FormField label="Longueur (m)" name="longueur" value={formData.longueur} onChange={setFormData} type="number" />
            <FormField label="Matériau" name="materiau" value={formData.materiau} onChange={setFormData} />
            <FormField label="Couleur" name="couleur" value={formData.couleur || '#3388ff'} onChange={setFormData} type="color" />
          </>
        )
      default:
        return (
          <>
            <FormField label="Nom" name="nom" value={formData.nom} onChange={setFormData} />
            <FormField label="Type" name="type" value={formData.type} onChange={setFormData} />
            <FormField label="Description" name="description" value={formData.description} onChange={setFormData} textarea />
            <FormField label="Couleur" name="couleur" value={formData.couleur || '#3388ff'} onChange={setFormData} type="color" />
          </>
        )
    }
...
function FormField({ label, name, value, onChange, type = 'text', textarea = false }) {
